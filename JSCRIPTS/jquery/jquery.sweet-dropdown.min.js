...
!function ($)
{
    ...
    return $.fn.sweetDropdown = function (method, data)
    {
        switch (method)
        {
            case "show": return $(this).click();
            case "hide": return $.sweetDropdown.hideAll(), $(this);
        }
    },
